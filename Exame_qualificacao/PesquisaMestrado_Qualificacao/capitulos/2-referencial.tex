...
Apesar do avanço, as redes recorrentes sofrem de uma limitação prática conhecida: ao processar as frases palavra por palavra, têm dificuldade em reter dependências entre termos distantes, o que prejudica a interpretação de sentenças longas e complexas. Foi a superação dessa limitação que abriu o estágio seguinte.
...
\citeonline{barak_fusion_2017} forneceram a fundamentação direta dessa estratégia ao demonstrar que a combinação de preditores diversos supera preditores individuais na previsão de retorno e de risco, e ao discutir como selecionar os componentes de um esquema de fusão. Evidências convergentes vieram de diferentes frentes. \citeonline{oliveira_impact_2017} avaliaram, com rigor metodológico, o valor de indicadores de sentimento e de atenção extraídos de microblogs para prever retorno, volatilidade e volume, empregando testes estatísticos formais de comparação de previsões. \citeonline{li_incorporating_2020} mostraram, para o mercado de Hong Kong, que modelos que combinam preços e sentimento de notícias superam aqueles que usam apenas uma das fontes, com vantagem para léxicos do domínio financeiro, resultado que reforça tanto a estratégia de fusão quanto a opção por um modelo de sentimento especializado. A Figura~\ref{fig:nobre} ilustra uma topologia preditiva representativa, na qual o pré-processamento dos dados antecede um classificador baseado em \textit{Extreme Gradient Boosting}.
