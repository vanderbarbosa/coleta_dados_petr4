...
**Gera:** `indice_sentimento_petr4.csv` e `noticias_com_sentimento.csv`
...
**Gera:** `resultados_modelos_petr4.csv` (Tabela 4.3), `base_master_petr4.csv`, `grafico_volatilidade_garch.png`, `grafico_dispersao_sentimento_volatilidade.png`, `relatorio_testes_estatisticos.txt`.
...
| `base_textual_petr4_2018_2025.csv` | Corpus de notícias (Script 02) |
